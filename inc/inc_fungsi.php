...
function url_dasar()
{
    //$S_SERVER['SERVER_NAME'] : adalah alamat website yang dipakai
    //$SERVER['SCRIPT_NAME'] :directory website yang dipakai
...
function buat_link_halaman($id)
{
    ...
    $r1 = mysqli_fetch_array($q1);
    $judul = $r1['judul'];
    // http://localhost/lsp1/halaman.php/16/judul
...
function tutors_foto($id)
{
    ...
    if ($foto) {
        ...
        return 'tutors_default_pictue.jpeg';
    }
}
...
function partners_foto($id)
{
    ...
    if ($foto) {
        ...
        return 'default_logo_partners.jpg';
    }
}
...
{
    $email_pengirim = "febrinew325@gmail.com";
    ...
    try {
        ...
        $mail->Password = 'enco kyna xeqj maxq';                               //SMTP password
