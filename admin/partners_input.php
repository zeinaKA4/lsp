...
if (isset($_POST['simpan'])) {
    ...
    if ($nama == '' or $isi == '') {
        $error = "Silahkan masukan semua data isi dan nama.";
    }
    if ($_FILES['foto']['name']) {
        ...
        $ekstensi_yang_diperbolehkan = array("jpg", "png", "jpeg");
        if (!in_array($foto_ekstensi, $ekstensi_yang_diperbolehkan)) {
            $error = "Mohon berikan gambar/foto dengan ekstensi jpg, jpeg, atau png";
